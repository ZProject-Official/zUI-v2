...
zUI.Separator = function(label, position)
    ...
    assert(position == nil or (type(position) == "string" and (position == "left" or position == "center" or position == "right")), "Separator position must be 'left', 'center', 'right' or nil")
